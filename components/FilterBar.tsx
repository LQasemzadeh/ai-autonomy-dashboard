...
export const FilterBar = () => {
  return (
    <div className="bg-white border-b border-slate-200 px-8 py-2.5 flex flex-wrap items-center gap-6 sticky top-0 z-10 shadow-sm shadow-slate-900/5">
      ...
      <button className="flex items-center gap-1.5 ml-auto text-[11px] font-bold text-slate-400 hover:text-indigo-600 transition-colors uppercase tracking-tight">
        <RotateCcw size={12} />
        Reset Filters
      </button>
    </div>
